    ...
    return (
        <Fragment>
            <nav className="relative px-4 py-2 flex justify-between items-center border-b-2">
                <a className="text-2xl font-bold text-text hover:text-bg" href="#">
                    HELLO SHOP
                </a>
                <div className="lg:hidden">
                    <button className="navbar-burger flex items-center text-text p-1" id="navbar_burger">
                ...
                <div className="hidden lg:flex">
                    ...
                    <a href="https://tailwindflex.com/playground">
                        <button className=" py-1.5 px-3 m-1 text-center border rounded-md text-text hover:bg-bg hidden lg:block">
                            GO TO STORE
                        </button>
                    </a>
                    <div>
